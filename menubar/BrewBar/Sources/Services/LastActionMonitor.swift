...
private let lastActionLogger = Logger(subsystem: "com.molinesdesigns.brewbar", category: "LastActionMonitor")
...
// SyncMonitor uses for iCloud — the goal is to keep BrewBar reactive to
